/*-------------------------------------------
    //This class presents instructions for a Grid which can be of 
    any size, essentially making up the maze in part 1 and being used
    for the gameboard in this part.

    Project 5 Part 2: Fire vs. Water
